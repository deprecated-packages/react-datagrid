	...
	_createClass(Select, [{
		...
		value: function _loadData(input) {
			...
			this.props.loadOptions(input, function (err, data) {
				if (!err) {
					_this4._setupSimpleValueLabelCache(data.options);
					var options = data.options.filter(_this4.selectValuesFilter.bind(_this4, _this4._getSanitizeValue()));
					if (_this4.props.creatable && options.length === 0) {
						var _options$push;

						options.push((_options$push = {
							creatable: true
						}, _defineProperty(_options$push, _this4.props.valueKey, "create"), _defineProperty(_options$push, _this4.props.labelKey, _this4.props.promptTextCreator(input)), _options$push));
					}
		...
		value: function _setupSimpleValueLabelCache(options) {
			...
			if (this.props.simpleValue) {
				...
				options.forEach(function (o) {
					simpleValueCache[o[_this5.props.valueKey]] = o[_this5.props.labelKey];
				});
			...
			if (this.props.simpleValue) {
				if (this.props.multi) {
					this.props.onChange(value.map(function (v) {
						return v[_this6.props.valueKey];
					}));
				} else {
			...
			if (this.props.multi) {
				if (v.hasOwnProperty(this.props.valueKey)) {
					return !itemSelected.map(function (x) {
						return x[_this7.props.valueKey] || !x.hasOwnProperty(_this7.props.valueKey);
			...
			return _react2.default.createElement(
				...
				{ className: this._getClassName(), style: { position: "relative" },
					ref: function ref(component) {
						return _this9.component = component;
					} },
				_react2.default.createElement(
					"div",
