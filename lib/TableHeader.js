	...
	_createClass(TableHeader, [{
		...
		value: function renderSortArrow(name) {
			if (this.props.model.sort.columns[name] === "DESC") {
				return _react2.default.createElement("i", { className: this.props.model.icons.sortDownIcon });
			} else if (this.props.model.sort.columns[name] === "ASC") {
				return _react2.default.createElement("i", { className: this.props.model.icons.sortUpIcon });
			} else {
				return null;
			}
		}
...
TableHeader.propTypes = {
	model: _propTypes2.default.shape({
		...
		settings: _propTypes2.default.shape({
			filterHeader: _propTypes2.default.bool.isRequired,
			editableColumns: _propTypes2.default.bool.isRequired
		}).isRequired,
		...
		icons: _propTypes2.default.shape({
			...
			removeIcon: _propTypes2.default.string,
			filterIcon: _propTypes2.default.string
		})
	}),
