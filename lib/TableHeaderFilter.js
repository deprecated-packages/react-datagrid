...
var TableHeaderFilter = function (_React$Component) {
	...
	function TableHeaderFilter(props) {
		...
		var _this = _possibleConstructorReturn(this, (TableHeaderFilter.__proto__ || Object.getPrototypeOf(TableHeaderFilter)).call(this, props));
...
TableHeaderFilter.propTypes = {
	model: _propTypes2.default.shape({
		...
		labels: _propTypes2.default.shape({
			...
			clearFilter: _propTypes2.default.string.isRequired
		}),
