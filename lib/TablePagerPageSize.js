...
var TablePagerPageSize = function (_React$Component) {
	...
	function TablePagerPageSize(props) {
		...
		var _this = _possibleConstructorReturn(this, (TablePagerPageSize.__proto__ || Object.getPrototypeOf(TablePagerPageSize)).call(this, props));
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"a",
							{ href: "#",
								onClick: this.onSetPage.bind(this, 10) },
							"10 ",
							this.props.model.labels.itemsPerPage
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"a",
							{ href: "#",
								onClick: this.onSetPage.bind(this, 15) },
							"15 ",
							this.props.model.labels.itemsPerPage
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"a",
							{ href: "#",
								onClick: this.onSetPage.bind(this, 30) },
							"30 ",
							this.props.model.labels.itemsPerPage
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"a",
							{ href: "#",
								onClick: this.onSetPage.bind(this, 50) },
							"50 ",
							this.props.model.labels.itemsPerPage
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"a",
							{ href: "#",
								onClick: this.onSetPage.bind(this, 75) },
							"75 ",
							this.props.model.labels.itemsPerPage
						)
					),
...
TablePagerPageSize.propTypes = {
	...
	model: _propTypes2.default.shape({
		pager: _propTypes2.default.shape({
			currentPageSize: _propTypes2.default.number.isRequired
		}).isRequired,
