	...
	render() {
		...
		return <span className="dropdown">
			...
			<ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
				...
				<li><a href="#" onClick={this.onSetPage.bind(this, 10)}>10 {this.props.model.labels.itemsPerPage}</a></li>
				<li><a href="#" onClick={this.onSetPage.bind(this, 15)}>15 {this.props.model.labels.itemsPerPage}</a></li>
				<li><a href="#" onClick={this.onSetPage.bind(this, 30)}>30 {this.props.model.labels.itemsPerPage}</a></li>
				<li><a href="#" onClick={this.onSetPage.bind(this, 50)}>50 {this.props.model.labels.itemsPerPage}</a></li>
				<li><a href="#" onClick={this.onSetPage.bind(this, 75)}>75 {this.props.model.labels.itemsPerPage}</a></li>
